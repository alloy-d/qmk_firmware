 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | ---- |Ctrl/[|Alt/{ | GUI  |Lower | Space|Raise |Space | GUI  | }/Alt|]/Ctrl| ---- |
 * `-----------------------------------------------------------------------------------'
 */
[_BASE] = LAYOUT_ortho(
    ...
    XXXXXXX, SC_LCBR, SC_LACB, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RGUI, SC_RACB, SC_RCBR, XXXXXXX
),
...
[_SYM] = LAYOUT_ortho(
    ...
    SC_LSBR, PSTWOFT, _______, KC_BSLS, KC_UNDS, KC_GRV,  _______, _______, _______, _______, _______, SC_RSBR,
