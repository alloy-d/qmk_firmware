 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Hyper| Ctrl | Alt  | GUI  |Lower | XXXX |Space |Raise | GUI  | Alt  | Ctrl |Hyper |
 * `-----------------------------------------------------------------------------------'
 */
[_BASE] = LAYOUT_ortho(
    ...
    KC_HYPR, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_NO,   KC_SPC,  RAISE,   KC_RGUI, KC_RALT, KC_RCTL, KC_HYPR
),
...
[_RAISE] = LAYOUT_ortho(
    ...
    _______, _______, _______, _______, _______, _______, TG(_NAV),_______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_NUM] = LAYOUT_ortho(
    ...
    _______, _______, _______, _______, _______, _______, KC_PLUS,      _______,KC_0,   KC_DOT, KC_ENTER,   _______
),
