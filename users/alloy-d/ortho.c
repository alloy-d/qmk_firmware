...
[_BASE] = LAYOUT_ortho(
    ...
    KC_HYPR, SC_LCBR, SC_LACB, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RGUI, SC_RACB, SC_RCBR, KC_HYPR
),
...
[_SYM] = LAYOUT_ortho(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, _______, _______, _______, _______, KC_QUOT, _______,
...
[_NUM] = LAYOUT_ortho(
    _______, _______, _______, _______, _______, _______, _______,      _______,_______,_______,_______,    _______,
    _______, _______, _______, _______, _______, _______, KC_SLASH,     KC_7,   KC_8,   KC_9,   _______,    _______,
